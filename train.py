...
parser.add_argument("--config", type=str, default='/home/hdd1/duke/AI4pain/MARLIN/config/celebv_hq/action/celebvhq_marlin_action_ft.yaml')
parser.add_argument("--data_dir", type=str, default='/home/hdd1/duke/AI4pain/AI4Pain_Dataset_full')
